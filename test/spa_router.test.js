...
import { SpaRouter, navigateTo, localisedRoute, routeIsActive } from '../src/spa_router.js'
import { adminRoutes } from "./test_routes.js"
...
describe('With site prefix', function() {
  ...
  describe('With admin routes', function() {
    describe('Employee index route', function() {
      beforeEach(function() {
        pathName = 'http://web.app/admin/employees'
        testRouter = SpaRouter([adminRoutes], pathName)
      })
      ...
      it('should set nested component name', function() {
        expect(testRouter.setActiveRoute().childRoute.component).to.equal('EmployeesLayout')
      })
    ...
    describe('Teams index route', function() {
      ...
      it('should set nested component name', function() {
        expect(testRouter.setActiveRoute().childRoute.component).to.equal('TeamsLayout')
      })

      it('should set nested index component name', function() {
        expect(testRouter.setActiveRoute().childRoute.childRoute.component).to.equal('TeamsIndex')
      })
    })

    describe('Team show route', function() {
      beforeEach(function() {
        pathName = 'http://web.app/admin/teams/show/my_id'
        testRouter = SpaRouter([adminRoutes], pathName)
      })

      it('should set path to root path', function() {
        expect(testRouter.setActiveRoute().path).to.equal('/admin/teams/show/my_id')
      })
      ...
      it('should update queryParams', function() {
        expect(testRouter.setActiveRoute().childRoute.childRoute.namedParams.id).to.equal('my_id')
      })

      it('should set nested index component name', function() {
        expect(testRouter.setActiveRoute().childRoute.childRoute.component).to.equal('TeamsShow')
      })
    })
  })
})
